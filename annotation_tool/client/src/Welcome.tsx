        ...
        <Content className="site-layout">
            ...
            >
                ...
                <div className="info">
                    ...
                    {/*            <Descriptions.Item span={2} label="How much will I be paid">2 GBP per task</Descriptions.Item>*/}
                    {/*            <Descriptions.Item span={1} label="How long will it take">8 minutes per task</Descriptions.Item>*/}
                    ...
                    {/*        <Descriptions bordered>*/}
                    {/*            <Descriptions.Item span={3} label="Is my personal information required">The dialogues in this study are entirely hypothetical and do not involve personal experiences and personal information. As part of the study, we will collect your voice recordings and demographic details, such as gender, age group, and native language. This data will be used and may be made publicly available in anonymised form strictly for research purposes.</Descriptions.Item>*/}

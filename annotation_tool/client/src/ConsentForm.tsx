...
import {contact_name, contact_email, contact_address, experiment_title} from "./configs";
                        ...
                        <Collapse defaultActiveKey={['1','2','3']}>
                            ...
                            <Collapse.Panel header="consent" key="3">
                                <p style={{"fontSize": 15, 'whiteSpace': 'pre-line'}}><b>
                                    ...
                                    <br/>
                                    <br/>
                                    Project title: Developing Multilingual Spoken Dialogue Systems for Enhancing Global Access to WHO Healthcare Education Information
                                    <br/>
                                    <br/>
                                    Research team: Research Team
                                    <br/>
                                    <br/>
                                    If you have any questions, please contact the research team at research-team@example.com
                                    <br/>
                                    <br/>
                                    1. I confirm that I have read and understand the information sheet dated [23/04/2024] for the above mentioned study and have had the opportunity to ask questions.
                                    <br/>
                                    <br/>
                                    ...
                                    <br/>
                                    <br/>
                                    6. I agree to participate in the above mentioned study run by the research team.
                                </b></p>
